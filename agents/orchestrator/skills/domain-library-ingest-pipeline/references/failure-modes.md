...
| Agent profile drift               | `library_phase33_dispatch.py --prepare` must fail if the global `agents/library-workers/domain-<lane>/<lane>.md` profile is missing, malformed, or mismatched |
